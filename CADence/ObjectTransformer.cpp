...
{
    DirectX::XMFLOAT3 pos = object->m_transform.GetPosition();
	...
	object->m_transform.SetPosition(
		pivot.x + diff.x,
		pivot.y + diff.y,
		pivot.z + diff.z
	);
    ...
    auto curRot = DirectX::XMLoadFloat3(&(object->m_transform.GetRotation()));
