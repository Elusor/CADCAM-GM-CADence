...
DividedCurve* DivideBernsteinCurvePos(std::vector<DirectX::XMFLOAT3> bernsteinCurve, float point)
{
	...
	it0_0 = bernsteinCurve[0];
	it0_1 = bernsteinCurve[1];
	it0_2 = bernsteinCurve[2];
	it0_3 = bernsteinCurve[3];
