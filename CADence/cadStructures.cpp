...
//}
//
//void Object::RenderCoordinates(std::unique_ptr<RenderState>& renderData, bool selected)
//{
...
//}
//
//void Object::RenderObject(std::unique_ptr<RenderState>& renderData, bool selected)
//{
//}
//
//
...
//}
//
//void SpawnMarker::RenderObject(std::unique_ptr<RenderState>& renderData, bool selected)
//{
//	//Update content to fill constant buffer
//	D3D11_MAPPED_SUBRESOURCE res;
//	XMMATRIX mvp = m_transform.GetModelMatrix() * renderData->m_camera->GetViewProjectionMatrix();
